package de.tu_berlin.cit.yahoo_benchmark_experiment.common.utils;
...
public enum Resources { GET;
    ...
    public <T> T read(String fileName, Class<T> clazz) throws Exception {
        ...
        if (!fileMap.containsKey(fileName)) {
            try (InputStream input = Resources.GET.getClass().getClassLoader().getResourceAsStream(fileName)) {
